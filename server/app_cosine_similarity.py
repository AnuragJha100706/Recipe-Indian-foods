...
def recommend_recipes(input_ingredients, n=10):
    ...
    recommended_recipes = recommended_recipes[["TranslatedRecipeName", "Cleaned-Ingredients", "TranslatedInstructions"]]
...
def recommend_api():
    ...
    for recipe in recommendations:
        recipe_tmp = recipe
        recipe_tmp["Cleaned-Ingredients"] = recipe_tmp["Cleaned-Ingredients"].split(",")
        if len(recipe_tmp["Cleaned-Ingredients"]) > 8:
            recipe_tmp["Cleaned-Ingredients"] = recipe_tmp["Cleaned-Ingredients"][:8]

        recipe_tmp["TranslatedInstructions"] = recipe_tmp["TranslatedInstructions"].split(".")[:-1]
